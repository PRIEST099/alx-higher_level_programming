...
class TestRectangle(unittest.TestCase):
    ...
    def test_two_args_id(self):
        rect1 = Rectangle(19, 4)
        rect2 = Rectangle(4, 3)
        self.assertEqual(rect1.id, rect2.id - 1)

    def test_three_args_id(self):
        rect1 = Rectangle(1, 2, 4)
        rect2 = Rectangle(9, 8, 6)
        self.assertEqual(rect1.id, rect2.id - 1)

    def test_custom_id(self):
        self.assertEqual(7, Rectangle(1, 2, 4, 5, 7).id)

    def test_four_args_id(self):
        rect1 = Rectangle(1, 2, 3, 4)
        rect2 = Rectangle(4, 6, 8, 7)
        self.assertEqual(rect1.id, rect2.id - 1)
    ...
    def test_getting_width(self):
        self.assertEqual(Rectangle(1, 2, 3, 4, 5).width, 1)

    def test_getting_height(self):
        self.assertEqual(Rectangle(1, 2, 3, 4, 5).height, 2)
